...
* If you want to get your feet wet with Haskell, the Yorgey CIS194 lecture introduction gives you a broad overview[1], which can be followed up with sample chapters[2] from the "Haskell Book"[3]. Additionally, Chris Allen's "Modeling Data in Haskell for Beginners" talk[4] also covers a slew of useful concepts.
* If you've not touched JavaScript before, I'd recommend reading some of the freely-available book, "Eloquent JavaScript"[5].
* If you want to get a head start, the "PureScript by Example" book[6] is a handy learning reference, but it's best tackled after dabbling in the above first.

1. http://www.seas.upenn.edu/~cis194/spring13/lectures/01-intro.html
2. http://haskellbook.com/images/sample.pdf
3. http://haskellbook.com/
4. https://www.youtube.com/watch?v=p-NBJm0kIYU
5. http://eloquentjavascript.net/
6. https://leanpub.com/purescript/read
